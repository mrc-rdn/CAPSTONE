  ...
  <div className="w-full h-full">
    <div className="w-full h-full overflow-y-scroll flex justify-center">
      ...
      <div className="h-100 w-10/12">
        <div
          className="bg-white shadow-2xl relative border-[15px] border-green-700 print:shadow-none"
          id="certificate"
        >
          <div className="p-16 lg:px-20 md:p-12 sm:px-8 sm:py-10 relative bg-white border-[3px] border-cert-gold min-h-[750px] overflow-hidden">

            {/* watermark */}
            <div className="absolute inset-0 flex items-center justify-center z-[1] pointer-events-none">
              <img
                src="/images/pqlogo.png"
                alt="Paranaque City Logo"
                className="w-[600px] opacity-[0.12]"
                onError={(e) => (e.target.style.display = "none")}
              />
            </div>

            {/* Decorative Corners */}
            <div className="absolute top-5 left-5 w-20 h-20 border-[3px] border-green-600 border-r-0 border-b-0 z-[2]"></div>
            <div className="absolute top-5 right-5 w-20 h-20 border-[3px] border-green-600 border-l-0 border-b-0 z-[2]"></div>
            <div className="absolute bottom-5 left-5 w-20 h-20 border-[3px] border-green-600 border-r-0 border-t-0 z-[2]"></div>
            <div className="absolute bottom-5 right-5 w-20 h-20 border-[3px] border-green-600 border-l-0 border-t-0 z-[2]"></div>
            ...
            <div className="relative z-[3] text-center">
              ...
              <h1
                className="font-playfair text-[64px] md:text-[42px] font-black text-black tracking-[12px] md:tracking-[6px] my-5 uppercase"
              ...
              <p className="text-base text-gray-800 mb-6 italic">
              ...
              <span className="font-bold text-black text-[22px] md:text-lg block my-4 capitalize">
                {title}
              </span>
              ...
              <p className="my-8 text-sm text-gray-800 italic">
                <span>
                  Completed on:{" "}
                  <strong>{completionDate.fullDate}</strong>
                </span>
                <span className="block mt-2 text-gray-800">
                  at <strong>{completionDate.time}</strong>
                </span>
              </p>

              <div className="my-9 text-[13px] text-gray-800">
                Issued at Parañaque City, Philippines this{" "}
                <strong>{completionDate.day}</strong> day of{" "}
                <strong>{completionDate.month}</strong>,{" "}
                <strong>{completionDate.year}</strong>
              </div>
