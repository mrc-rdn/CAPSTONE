...
import AddChapterModal from './UI/modal/AddChapterModal';
import AddTraineeModal from './UI/modal/AddTraineeModal';
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import axios from 'axios'
import Chapter from './course/Chapter';
import VideoUploadModal from './UI/modal/VideoUploadModal';
...
import UploadImages from './UI/modal/uploadImagesModal';
    ...
    async function handleShowChapter(id, chapter_index){
      ...
      try {
        const [video, quiz] = await Promise.all([
          axios.post(`${API_URL}/admin/chapter/videoitems`, {courseId: course.id, chapterId: id  }, {withCredentials: true}),
