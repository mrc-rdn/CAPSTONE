    ...
    <div className='w-11/12 h-70 flex justify-center items-center'>
        <div className='w-11/12 h-50 bg-green-700 rounded-3xl flex p-5'>
            ...
            <div className='w-180 h-full flex justify-center items-center gap-8'>
                <section className='h-40 w-35  bg-white/10 border border-emerald-500/30 text-white rounded-3xl border-white border flex justify-center items-center flex-col'>
