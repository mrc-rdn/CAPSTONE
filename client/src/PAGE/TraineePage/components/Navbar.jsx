...
export default function TraineeNavbar() {
  ...
  // Menu items specifically for the Trainee
  const menuItems = [
    { name: 'Dashboard', path: '/trainee/dashboard', icon: DashboardIcon },
    { name: 'My Courses', path: '/trainee/course', icon: GroupsIcon },
    { name: 'Messages', path: '/trainee/messages', icon: MessageIcon },
  ];
  ...
  return (
    <motion.div 
      ...
      /* Seamless Design: No margins, continuous height, dark mode ready */
    ...
    >
      {/* BRAND SECTION: Matches Header height (h-20) */}
      <div className={cn(
            ...
            {isExpanded && (
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Trainee Hub</span>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
...
/** * Utility function for cleaner Tailwind class merging
 */
function cn(...inputs) {
