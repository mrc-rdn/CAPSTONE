...
function Comments({ videoId }) {
  ...
  const [isComments, setIsComments] = useState(false)
    ...
    useEffect(() => {
        ...
        try {
            const res = await axios.get(`http://localhost:3000/trainee/${videoId}/comments`, {withCredentials:true});
  ...
  // Add new comment
    const addComment = async () => {
        ...
        try {
        const res = await axios.post(`http://localhost:3000/trainee/${videoId}/comments`, {
            content: input,
    ...
    const deleteComment = async (id) => {
        try {
            const res = await axios.post(`http://localhost:3000/trainee/video/deletecomment`, {
            commentId: id
            }, { withCredentials: true });
