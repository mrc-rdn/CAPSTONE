...
export default function EditUserInfo(props) {
  ...
  return (
    <div className=' '>
        ...
        <div 
            className='flex items-center flex-col mb-3 relative'
        ...
        :<form action="" className=' flex  flex-wrap '>
            ...
            <div className='p-2 w-full'>
                ...
                <input 
                className=' w-full h-8 text-lg bg-green-600 rounded p-1 my-2 mx-1 '
                type="text" 
                name='surname'
            ...
            <div className='text-red-500'>
                {isPasswordMatch? 'Please make sure your passwords match': null}
            </div>
            ...
            <div className='w-full flex justify-center'>
                ...
                <button 
                    className={isMouseOver1?'m-3 w-30 h-10 text-sm text-green-600 bg-white border-2 border-green-500 rounded ':'m-3 w-30 h-10 text-sm text-white bg-green-600 rounded font-bold' }
