...
export default function ContactList({userData, socket}) {
    ...
    useEffect(()=>{ 
        const fetchContacts = async() =>{
            try {
                const fetchData = await axios.get(`${API_URL}/trainee/chats`, {withCredentials:true})
    ...
    const handleSendMessage = async(e)=>{
        ...
        try {
            ...
            const fetchData = await axios.post(`${API_URL}/trainee/sendMessage`,{chat_id:contactId ,message:message}, {withCredentials:true})
            setMessage("")
