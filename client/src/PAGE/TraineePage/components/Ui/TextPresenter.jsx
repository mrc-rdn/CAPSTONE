...
export default function TextPresenter({data}) {
        ...
        const handleprogress = async()=>{
            const sendprogress = await axios.post(`${API_URL}/trainee/chapterprogress/${data[0].course_id}/${data[0].chapter_id}`,{}, {withCredentials:true})
            console.log(sendprogress.data)
        }
