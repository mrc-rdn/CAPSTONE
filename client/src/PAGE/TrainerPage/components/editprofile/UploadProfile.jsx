...
export default function UploadProfile(props) {
  ...
  <div className="w-[520px] max-w-full bg-white dark:bg-slate-900 backdrop-blur-xl border border-white/30 dark:border-slate-800 rounded-[2.5rem] shadow-2xl p-8 relative overflow-hidden transition-colors duration-300">
      ...
      : (
        ...
        >
          ...
          <button
            ...
            "
          >
            {uploading ? "Sychronizing..." : "Apply Changes"}
          </button>
