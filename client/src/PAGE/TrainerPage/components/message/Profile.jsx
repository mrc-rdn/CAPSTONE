...
export default function Profile(props) {
  ...
  return (
    <div className="px-2">
      <li
        className="w-full h-16 flex items-center gap-4 px-4 cursor-pointer rounded-2xl hover:bg-emerald-50/50 border border-transparent hover:border-emerald-100 transition-all group"
        onClick={() => {
          if (props.onSelect) {
